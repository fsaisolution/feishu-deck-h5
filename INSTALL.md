...
> "帮我安装 feishu-deck-h5 这个 skill：`https://github.com/fsaisolution/feishu-deck-h5.git`"
...
```
/plugin marketplace add https://github.com/fsaisolution/feishu-deck-h5.git
...
```bash
git clone https://github.com/fsaisolution/feishu-deck-h5.git /tmp/feishu-deck-h5-installer
...
```bash
git clone https://github.com/fsaisolution/feishu-deck-h5.git ~/Projects/feishu-deck-h5
